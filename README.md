...
\* Serialization methods (`to\_dict`/`from\_dict`) for save system
...
\* \*\*Active Game\*\*: `saved\_game.json` (JSON format)  

\* \*\*Game History\*\*: `battleship\_save.txt` (text format, one result per line)
